...
public interface UserCombinationFavoriteRepository {
        UserCombinationFavoriteModel findByCombinationUrlAndUserEmail(String combinationUrl, String userEmail)
                        throws UserCombinationFavoriteNotFoundException;

        UserCombinationFavoriteEntity addToFavorite(String combinationUrl, String userEmail)
                        throws UserNotFoundException;

        void deleteFromFavorites(String garmentCode, String userEmail) throws UserNotFoundException;

        PageDTO<UserCombinationFavoriteModel> getCombinationFavoritesForUserByEmail(String userEmail, int page)
