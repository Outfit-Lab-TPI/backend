...
public class UserCombinationFavoriteRepositoryImpl implements UserCombinationFavoriteRepository {
    ...
    public UserCombinationFavoriteRepositoryImpl(
            UserCombinationFavoriteJpaRepository userCombinationFavoriteJpaRepository,
    ...
    @Override
    public UserCombinationFavoriteModel findByCombinationUrlAndUserEmail(String combinationUrl, String userEmail)
            throws UserCombinationFavoriteNotFoundException {
        UserCombinationFavoriteEntity entity = this.userCombinationFavoriteJpaRepository
                .findBycombinationUrlAndUser_Email(combinationUrl, userEmail);
        if (entity == null)
            throw new UserCombinationFavoriteNotFoundException(
                    "El usuario no tiene la combinacion con esta URL: " + combinationUrl + " como favorito.");
    ...
    @Override
    public UserCombinationFavoriteEntity addToFavorite(String combinationUrl, String userEmail)
        ...
        return this.userCombinationFavoriteJpaRepository
                .save(new UserCombinationFavoriteEntity(user, combinationUrl));
    }
    ...
    public void deleteFromFavorites(String comninationUrl, String userEmail) throws UserNotFoundException {
        ...
        this.userCombinationFavoriteJpaRepository.delete(this.userCombinationFavoriteJpaRepository
                .findBycombinationUrlAndUser_Email(comninationUrl, user.getEmail()));
    }


    @Override
    public PageDTO<UserCombinationFavoriteModel> getCombinationFavoritesForUserByEmail(String userEmail, int page)
        ...
        Page<UserCombinationFavoriteModel> combinationPage = favorites
                .map(UserCombinationFavoriteEntity::convertEntityToModelWithoutUser);
        return new PageDTO<>(
